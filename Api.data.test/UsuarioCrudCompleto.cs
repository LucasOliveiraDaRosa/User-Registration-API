    ...
    public class UsuarioCrudCompleto : BaseTest, IClassFixture<DbTest>
    {
        ...
        public async Task E_Possivel_Realizar_CRUD_Usuario()
        {
            using (var context = _serviceProvider.GetService<MyContext>())
            {
                ...
                var _usuarioPadrao = await _repositorio.FindByLogin("dev.lucasrosa@gmail.com");
                Assert.NotNull(_usuarioPadrao);
                Assert.Equal("dev.lucasrosa@gmail.com", _usuarioPadrao.Email);
                Assert.Equal("Adminstrador", _usuarioPadrao.Name);
